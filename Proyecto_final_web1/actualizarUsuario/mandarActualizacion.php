...
<body class="fondocolores">
  ...
  $sql = "UPDATE usuarios SET nombre_usuario='$nombre_usuario',telefono='$telefono',edad='$edad', email='$email', password='$password' WHERE id='$id'";
            ...
            <form action="actualizar.php" method="post" class="row g-4 mt-4">
                <div class="my-2">
                    ...
                    <figure class="text-center">
                      <img src="../imagenes/gatitolike.jpg" class="figure-img img-fluid rounded" width="200px" height="200px">
                    </figure>
                </div>
                <div class="container w-75 mt-50 text-center"style="background-color: #1A083C;">
