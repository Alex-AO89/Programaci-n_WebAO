...
?>
    ...
    <div class="container w-75 bg-dark mt-3 rounded shadow">
        <div class="row">
            ...
            <h5 style="color: white;" class="fw-bold text-center pt-3 mb-3">¿Quieres actualizar los datos de un usuario?<a href="./actualizarUsuario/actualizar.php"> Actualizar</a></h5>
            <h5 style="color: white;" class="fw-bold text-center pt-2 mb-3">¿Quieres eliminar un usuario?<a href="./eliminarUsuario/eliminar.html"> Eliminar</a></h5>
