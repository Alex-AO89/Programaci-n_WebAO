...
?>
    ...
    <div class="container w-75 bg-dark mt-5 rounded shadow">
        ...
        <form class="row g-4 mt-4" method="POST" action="mandarActualizacion.php">
            ...
            <div class="col-12">
                <label style="color: white;"  for="edad" class="form-label">Edad</label>
                <input type="number" name="edad" class="form-control" value="<?=$edad?>" placeholder="Ingresa tu edad"/>
            </div>
            <div class="col-12">
